...
_KO_STOP = {
    ...
    "최신", "총정리", "완벽정리", "핵심정리", "기본", "완전정리",
    # 연도·지역
    "2026", "2025", "2024", "한국", "국내",
    # 제목 수식어 (극히 흔함)
    "기준", "핵심", "필수", "중요", "간단", "쉽게", "빠르게", "제대로",
    "알아보기", "알아야", "알아두면", "알고보면", "모르면", "몰랐던",
    "나만", "다들", "우리", "여러분", "바로", "지금", "오늘", "처음",
    "이것", "이게", "이거", "저도", "사실", "진짜", "정말", "혹시",
}
_EN_STOP = {
    # articles / prepositions / conjunctions
    "the", "how", "why", "what", "with", "for", "and", "from", "about",
    "into", "out", "over", "not", "but", "are", "was", "has", "have",
    # common title verbs / adjectives
    "use", "using", "get", "make", "that", "this", "your", "you",
    "best", "top", "guide", "tips", "ways", "list",
    # title pattern words
    "choose", "right", "wrong", "complete", "simple", "easy", "quick",
